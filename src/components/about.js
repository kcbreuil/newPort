    ...
    <div id="about" className="h-full flex flex-col gap-4 text-center m-20">
      <div className="md:w-4/5 place-self-center">
        ...
        <p className="mb-10 text-3xl">
          Hi there! I am a senior frontend developer born and raised in the subtropical
          swamps of South Florida. After 7 years in the arts marketing,
          ...
          sense of design and a knack for problem solving, I have spent the
          past few years developing UI and design systems for agencies,
          enterprises and startups around the US. I work really well in a team
          setting, working asynchronously and collaborating with designers and
          developers alike but can also be found slaying it on my own. When I am
